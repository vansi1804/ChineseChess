...
public class TrainingController {
  ...
  @Operation(
    summary = "Find an existing training by id",
    description = "Endpoint to find amn existing training by id",
    responses = {
      @ApiResponse(
        responseCode = "200",
        description = "Successfully",
  ...
  @Operation(
    summary = "Find an existing training's details by id",
  ...
  @Operation(
    summary = "Update an existing trainings",
