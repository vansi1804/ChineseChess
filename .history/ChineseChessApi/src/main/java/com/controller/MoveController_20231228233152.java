...
public class MoveController {
  ...
  public ResponseEntity<List<int[]>> findAllAvailable(
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
      description = "Available move data Request",
      required = true,
  ...
  public ResponseEntity<MoveDTO> create(
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
      description = "Training move data to create",
      required = true,
      content = @Content(schema = @Schema(implementation = TrainingMoveCreationDTO.class))
  ...
  public ResponseEntity<Map<Boolean, BestAvailableMoveResponseDTO>> findAllBestAvailable(
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
      description = "Best available move data request",
      required = true,
      content = @Content(schema = @Schema(implementation = BestAvailableMoveRequestDTO.class))
