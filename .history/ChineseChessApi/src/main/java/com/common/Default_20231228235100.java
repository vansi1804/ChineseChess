...
public class Default {
  ...
  public static class JWT {
    ...
    public static final String SECRET =
      "V2hlbiB5b3UgYXJlIGdvaW5nIHRvIGdpdmUgdXAsIHRoaW5rIGFib3V0IHRoZSByZWFzb24gbWFkZSB5b3Ugc3RhclQNCg==";

    public static final long ACCESS_TOKEN_EXPIRATION_TIME = 1000 * 60 * 60;

    public static final long REFRESH_EXPIRATION_TIME =
      ACCESS_TOKEN_EXPIRATION_TIME * 24;
