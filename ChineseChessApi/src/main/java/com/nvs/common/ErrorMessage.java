...
public class ErrorMessage{
   ...
   public static final String COL = Default.Game.PlayBoardSize.COL_MIN + " <= col <= " + Default.Game.PlayBoardSize.COL_MAX;
   ...
   public static final String ROW = Default.Game.PlayBoardSize.ROW_MIN + " <= col <= " + Default.Game.PlayBoardSize.ROW_MAX;
