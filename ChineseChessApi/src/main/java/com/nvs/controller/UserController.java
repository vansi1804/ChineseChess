...
public class UserController{
   ...
   @GetMapping(value = "")
   public ResponseEntity<Page<UserDTO>> findAll(@RequestParam(defaultValue = Default.Page.NO) int no, @RequestParam(defaultValue = Default.Page.LIMIT) int limit, @RequestParam(defaultValue = Default.Page.SORT_BY) String sortBy){
   ...
   public ResponseEntity<UserProfileDTO> changePassword(@PathVariable long id, @RequestBody @Valid UserChangePasswordRequestDTO userChangePasswordRequestDTO){
