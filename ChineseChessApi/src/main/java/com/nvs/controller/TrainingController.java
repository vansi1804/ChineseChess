...
public class TrainingController{
   ...
   @PostMapping(value = "")
   public ResponseEntity<TrainingDTO> create(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Training data to create", required = true, content = @Content(schema = @Schema(implementation = TrainingDTO.class))) @RequestBody @Valid TrainingDTO trainingDTO){
