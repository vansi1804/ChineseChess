...
public class PlayerController{
   ...
   @GetMapping(value = "")
   public ResponseEntity<Page<PlayerDTO>> findAll(@RequestParam(defaultValue = Default.Page.NO) int no, @RequestParam(defaultValue = Default.Page.LIMIT) int limit, @RequestParam(defaultValue = Default.Page.SORT_BY) String sortBy){
   ...
   @PreAuthorize("isAuthenticated()")
   @PutMapping(value = "/{id}")
   public ResponseEntity<PlayerProfileDTO> update(@PathVariable long id, @RequestBody @Valid PlayerProfileDTO playerProfileDTO){
