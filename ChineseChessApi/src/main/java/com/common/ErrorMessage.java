...
public class ErrorMessage {
    ...
    public static final String CUMULATIVE_TIME = ">= " + Validation.CUMULATIVE_TIME + "(seconds)";
    ...
    public static final String MATCH_TIME = ">= " + Validation.MATCH_TIME + "(minutes)";

    public static final String MOVING_TIME = ">= " + Validation.MOVING_TIME + "(seconds)";
