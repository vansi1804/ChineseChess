...
public class MoveRuleServiceImpl implements MoveRuleService {
  ...
  private static final int CENTER_COL_MIN =
    Default.Game.PlayBoardSize.CENTER_COL_MIN;
  private static final int CENTER_COL_MAX =
    Default.Game.PlayBoardSize.CENTER_COL_MAX;

  private static final int BLACK_ROW_MAX =
    Default.Game.PlayBoardSize.BlackArea.ROW_MAX;
  private static final int BLACK_CENTER_ROW_MIN =
    Default.Game.PlayBoardSize.BlackArea.CENTER_ROW_MIN;
  private static final int BLACK_CENTER_ROW_MAX =
    Default.Game.PlayBoardSize.BlackArea.CENTER_ROW_MAX;

  private static final int RED_ROW_MIN =
    Default.Game.PlayBoardSize.RedArea.ROW_MIN;
  private static final int RED_CENTER_ROW_MIN =
    Default.Game.PlayBoardSize.RedArea.CENTER_ROW_MIN;
  private static final int RED_CENTER_ROW_MAX =
    Default.Game.PlayBoardSize.RedArea.CENTER_ROW_MAX;
  ...
  public boolean isValid(
    ...
    switch (ePiece) {
      case SOLDIER:
        return this.checkSoldierMoveRule(
            pieceDTO.isRed(),
            fromCol,
            toCol,
            fromRow,
      ...
      case CANNON:
        return this.checkCannonMoveRule(
            playBoardDTO,
            fromCol,
            toCol,
            fromRow,
      ...
      case GUARD:
        return this.checkGuardMoveRule(
            pieceDTO.isRed(),
            fromCol,
            toCol,
            fromRow,
      ...
      case ELEPHANT:
        return this.checkElephantMoveRule(
            playBoardDTO,
            pieceDTO.isRed(),
            fromCol,
            toCol,
      ...
      case HORSE:
        return this.checkHorseMoveRule(
            playBoardDTO,
            fromCol,
            toCol,
            fromRow,
      ...
      case CHARIOT:
        return this.checkChariotMoveRule(
            playBoardDTO,
            fromCol,
            toCol,
            fromRow,
      ...
      default:
        return this.checkGeneralMoveRule(
            pieceDTO.isRed(),
            fromCol,
            toCol,
            fromRow,
   ...
   */
  private boolean checkGeneralMoveRule(
    boolean isRed,
    int fromCol,
    int toCol,
    int fromRow,
    ...
    return (
      isInAreaCenter(isRed, toCol, toRow) &&
      (
        (
        ...
        (
          moveTypeService.isVerticallyMoving(fromCol, toCol) &&
   ...
   */
  private boolean checkGuardMoveRule(
    boolean isRed,
    int fromCol,
    int toCol,
    int fromRow,
  ...
  private boolean checkElephantMoveRule(
    ...
    boolean existingObstacle =
      playBoardDTO.getState()[middleCol][middleRow] != null;
   ...
   */
  private boolean checkHorseMoveRule(
    PlayBoardDTO playBoardDTO,
    int fromCol,
    int toCol,
    int fromRow,
   ...
   */
  private boolean checkChariotMoveRule(
    PlayBoardDTO playBoardDTO,
    int fromCol,
    int toCol,
    int fromRow,
    ...
    return (
      (
        moveTypeService.isVerticallyMoving(fromCol, toCol) &&
        !pieceService.existsBetweenInColPath(
          playBoardDTO,
          fromCol,
          fromRow,
          toRow
      ...
      (
        moveTypeService.isHorizontallyMoving(fromRow, toRow) &&
        !pieceService.existsBetweenInRowPath(
          playBoardDTO,
          fromRow,
          fromCol,
          toCol
   ...
   */
  private boolean checkCannonMoveRule(
    PlayBoardDTO playBoardDTO,
    int fromCol,
    int toCol,
    int fromRow,
    ...
    PieceDTO targetPiece = playBoardDTO.getState()[toCol][toRow];
    boolean isVerticallyMoving = moveTypeService.isVerticallyMoving(
      fromCol,
      toCol
    );
    boolean isHorizontalMoving = moveTypeService.isHorizontallyMoving(
      fromRow,
      toRow
    );
    ...
    if (isVerticallyMoving || isHorizontalMoving) {
      int numPiecesBetween = isVerticallyMoving
        ? pieceService.countBetweenInColPath(
          playBoardDTO,
          fromCol,
          fromRow,
          toRow
        )
        : pieceService.countBetweenInRowPath(
          playBoardDTO,
          fromRow,
          fromCol,
          toCol
   ...
   */
  private boolean checkSoldierMoveRule(
    boolean isRed,
    int fromCol,
    int toCol,
    int fromRow,
    ...
    return (
      ...
      (
        moveTypeService.isHorizontallyMoving(fromRow, toRow) &&
        this.isOverTheRiver(isRed, fromRow) &&
  ...
  private boolean isInAreaCenter(boolean isRed, int col, int row) {
    return (
      ((CENTER_COL_MIN <= col) && (col <= CENTER_COL_MAX)) &&
      (
        isRed
          ? ((RED_CENTER_ROW_MIN <= row) && (row <= RED_CENTER_ROW_MAX))
