...
public class FileController {
    ...
    @Operation(description = "Upload file", responses = {
            @ApiResponse(responseCode = "200", description = "Successfully uploaded file", content = @Content(mediaType = "text/plain", schema = @Schema(implementation = String.class)))
    })
    @ApiResponses(value = {
    ...
    @Operation(description = "Download file", responses = {
            @ApiResponse(responseCode = "200", description = "Successfully downloaded file", content = @Content(mediaType = "application/octet-stream")),
    ...
    @Operation(description = "Display file on the web", responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved file", content = @Content(mediaType = "application/octet-stream")),
            @ApiResponse(responseCode = "404", description = "Not found"),
            @ApiResponse(responseCode = "500", description = "Internal Server Error")
    })
