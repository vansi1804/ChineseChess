...
public class PlayerController {
    ...
    @Operation(summary = "Find all players", description = "Retrieve a paginated list of all players", responses = {
    ...
    @Operation(summary = "Find player by user ID", description = "Retrieve a player by their user ID", responses = {
            @ApiResponse(responseCode = "200", description = "Successfully")
    })
    @PreAuthorize(value = "hasAuthority('ADMIN')")
    ...
    @Operation(summary = "Find player by ID", description = "Retrieve a player by their ID", responses = {
            @ApiResponse(responseCode = "200", description = "Successfully")
    })
    ...
    @Operation(summary = "Create a player", description = "Create a new player", requestBody = @RequestBody(description = "Player data to create", required = true, content = @Content(schema = @Schema(implementation = PlayerCreationDTO.class))), responses = {
            @ApiResponse(responseCode = "200", description = "Successfully")
    })
    @PostMapping(value = "")
    ...
    @Operation(summary = "Update player profile", description = "Update a player's profile", requestBody = @RequestBody(description = "Player data to update", required = true, content = @Content(schema = @Schema(implementation = PlayerProfileDTO.class))), responses = {
            @ApiResponse(responseCode = "200", description = "Successfully")
    })
    @PreAuthorize("isAuthenticated()")
