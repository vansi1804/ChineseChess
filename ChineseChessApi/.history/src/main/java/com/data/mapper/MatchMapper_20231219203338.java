  ...
  @Mappings(
    {
      ...
      @Mapping(source = "player2", target = "cumulativeTime"),
      @Mapping(source = "player2", target = "eloBet"),
      @Mapping(source = "player2", target = "movingTime"),
...
//cumulativeTime, eloBet, movingTime, player1, player2, time
  @Mappings(
    {
