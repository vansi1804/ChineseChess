...
@Component
public class MatchOthersInfoCreationDTOValidatorIml
  implements ConstraintValidator<Validator, MatchOthersInfoDTO> {

  @Override
  public boolean isValid(
    MatchOthersInfoDTO matchOthersInfoDTO,
    ConstraintValidatorContext context
  ) {
    if (
      matchOthersInfoDTO == null ||
      (
      ...
      throw new InvalidExceptionCustomize(
        Collections.singletonMap(
          "message",
          "matchOthersInfoDTO is null or matchOthersInfoDTO's fields are null or not null all"
        )
      );
    }
  }
